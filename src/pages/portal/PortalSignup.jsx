...
export default function PortalSignup() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!supabase) { setError('The Parent Portal has not been configured yet.'); setSubmitting(false); return }
    ...
    const { data, error: registrationError } = await supabase.functions.invoke('register-parent', {
      body: { fullName: form.fullName, phone, password: form.password, admissionNumber: form.admissionNumber, dateOfBirth: form.dateOfBirth },
    })
